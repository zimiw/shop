...
public class ActivityAdminModule {
    ...
    public Object queryBranner() {
        ...
        List<ActivityBranner> list = dao.query(ActivityBranner.class, Cnd.where("status", "=", 1).desc("seq")
                .desc("id"));
        return list;
    }
     ...
     */
    @At
    public Object queryActivityList(@Param("productId") String productId, @Param("productName") String productName,
        ...
        String sqlStr = "SELECT b.activityId, a.productId, a.name, a.minPrice, b.price,"
                ...
                + " ( CASE  WHEN b.activityNum>b.num  THEN '已售罄' "
        ...
        sql.params().set("dayTime", TimeUtils.dateToStr(new Date(), TimeUtils.FORMAT14));
     ...
     */
    @At
    public Object queryActivityProductList(@Param("productId") String productId,
            @Param("productName") String productName, @Param("rows") int pageSize, @Param("page") int pageNum) {
     ...
     */
    @At
    public Object saveActivity(@Param("..") final ActivityProduct activityProduct) {

        Map<String, Object> result = new HashMap<String, Object>();

        if (StringUtils.isEmpty(activityProduct.getProductId()) || StringUtils.isEmpty(activityProduct.getBeginTime())
        ...
        Trans.exec(new Atom() {
            ...
            public void run() {
                ...
                dao.update(Product.class, Chain.make("activityType", 1),
                        Cnd.where("productId", "=", activityProduct.getProductId()));
            }
        });
    ...
    public Object delActivity(@Param("activityId") String activityId) {
        ...
        Map<String, Object> result = new HashMap<String, Object>();
        int res = dao.update(ActivityProduct.class, Chain.make("status", 0), Cnd.where("activityId", "=", activityId));
    ...
    public Object queryActivtySpecialtyList() {
        ...
        List<ActivtySpecialty> list = dao.query(ActivtySpecialty.class, Cnd.NEW().desc("beginTime").desc("endTime"));
        return list;
    }
     ...
     */
    @At
    public Object saveActivtySpecialty(@Param("..") final ActivtySpecialty activtySpecialtys) {
        Map<String, Object> result = new HashMap<String, Object>();
     ...
     */
    @At
    public Object queyActivtyHeatTwoList(@Param("rows") int pageSize, @Param("page") int pageNum) {

        return selectActivtyHeatList("2", pageSize, pageNum);
    }

    private List<Product> selectActivtyHeatList(String type, int pageSize, int pageNum) {
    ...
    public Object saveActivtyHeat(@Param("..") final ActivtyHeat activtyHeat) {
        ...
        if (StringUtils.isEmpty(activtyHeat.getProductId()) || StringUtils.isEmpty(activtyHeat.getType())) {
            result.put("status", ResultVo.STATUS_FAIL);
            result.put("msg", "保存参数不能为空!");
            return result;
        }
        ...
        Trans.exec(new Atom() {
            ...
            public void run() {
                ...
                // 根据商品中对应的状态
                dao.update(Product.class, Chain.make("activityType", aactivtyType),
    ...
    public Object delActivtyHeat(@Param("..") final ActivtyHeat activtyHeat) {
        ...
        Trans.exec(new Atom() {
            @Override
            public void run() {
                dao.clear(ActivtyHeat.class,
                        Cnd.where("id", "=", activtyHeat.getId()).and("type", "=", activtyHeat.getType()));

                // //参加活动类型 0无活动 1限时活动 2热卖一 3热卖二
                int aactivtyType = activtyHeat.getType() == 1 ? 2 : 3;

                // 根据商品中对应的状态
                dao.update(Product.class, Chain.make("activityType", 0),
                        Cnd.where("productId", "=", activtyHeat.getProductId()).and("activityType", "=", aactivtyType));
            }
        });
     ...
     */
    @At
    public Object queryLotteryList(@Param("rows") int pageSize, @Param("page") int pageNum) {
        ...
        Sql sql = Sqls.create(sqlStr);
        sql.params().set("day", TimeUtils.dateToStr(TimeUtils.getNextDay(new Date(), -1), TimeUtils.FORMAT10));// 昨天的时间
    ...
    public Object addLottery(@Param("orderId") int orderId) {
        ...
        ActivityLottery activityLottery = dao.fetch(ActivityLottery.class, Cnd.where("orderId", "=", orderId));
     ...
     */
    @At
    public Object addLotteryConf(@Param("lotteryTime") String lotteryTime, @Param("rate") String rate) {
